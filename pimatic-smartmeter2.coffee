...
module.exports = (env) ->
  ...
  class Smartmeter2 extends env.plugins.Plugin

    init: (app, @framework, @config) =>
      deviceConfigDef = require("./device-config-schema")

      @framework.deviceManager.registerDeviceClass("Smartmeterdevice2", {
        configDef: deviceConfigDef.Smartmeterdevice2,
        createCallback: (config) => new Smartmeterdevice2(config)
      })

  class Smartmeterdevice2 extends env.devices.Sensor
